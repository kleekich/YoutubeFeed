...
const API_KEY = 'AIzaSyCpNGhgOqGsWhD502t0PBuS4GB8i5mIDJc';
...
class App extends Component  {
	...
	//return JSX
	render() {
		//We would like to call videoSearch(term) function only in every a few seconds.
		//SO we use debounce of lodash
